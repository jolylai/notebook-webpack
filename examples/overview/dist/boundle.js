...
/******/ (() => {
  ...
  /******/ /******/ __webpack_require__.m = __webpack_modules__; /* webpack/runtime/define property getters */
  /******/
  ...
  /******/ /******/ (() => {
    /******/ var inProgress = {};
    /******/ var dataWebpackPrefix = 'overview:'; // loadScript function to load a script via script tag
  ...
  /******/ /******/ (() => {
    ...
    /******/ __webpack_require__.f.j = (chunkId, promises) => {
      ...
      /******/
    }; // no prefetching // no preloaded // no HMR // no HMR manifest // no deferred startup // install a JSONP callback for chunk loading
    /******/
    ...
    /******/ var chunkLoadingGlobal = (self['webpackChunkoverview'] =
      self['webpackChunkoverview'] || []);
  ...
  \**********************/
  eval(
    '__webpack_require__.e(/*! import() */ "src_math_js").then(__webpack_require__.bind(__webpack_require__, /*! ./math */ "./src/math.js")).then(({ add }) => {\n  add(1, 2);\n});\n\n\n//# sourceURL=webpack://overview/./src/index.js?',
  );
  /******/
})();
